...
![Waitlist Settings](../assests/create-events/waitlist/waitlist-settings.png)
...
![Waitlist Communications](../assests/create-events/waitlist/communications.png)
...
![Spot Available Notification](../assests/create-events/waitlist/spot-available-notification.gif)
...
![waitlist-notify-email-settings](../assests/create-events/waitlist/waitlist-notify-email-settings.png)

After finalizing your changes, click Save Changes to update and activate your customized notification.

![waitlist-notify-email-save](../assests/create-events/waitlist/waitlist-notify-email-save.png)
...
![Waitlist-confirmation-email-vid](../assests/create-events/waitlist/waitlist-confirmation-email-vid.gif)

After finalizing your changes, click **Save Changes** to update and activate your customized notification.

![waitlist-confirmation-email-save](../assests/create-events/waitlist/waitlist-confirmation-email-save.png)
...
![Waitlist Subscribers](../assests/create-events/waitlist/waitlist-subscribers.png)
...
![notifying-waitlist-attendees](../assests/create-events/waitlist/notifying-waitlist-attendees.gif)

2. Click on the **Customize Email Template** button if you wish to send a personalized message to the attendee.

![cust-email-template](../assests/create-events/waitlist/cust-email-template.gif)
...
![send-notification](../assests/create-events/waitlist/send-notification.png)

You can check the status of the attendee, which will change from **Pending** to **Notified** once the notification has been sent.

![status-notification](../assests/create-events/waitlist/status-notified.png)
...
![delete-attendee-waitlist](../assests/create-events/waitlist/delete-attendee-waitlist.gif)
...
![view-attend-analysis-attendee-waitlist](../assests/create-events/waitlist/view-attend-analysis-attendee-waitlist.gif)