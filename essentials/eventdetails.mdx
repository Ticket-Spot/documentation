...
![event-type](../assests/create-events/eventdetails/event-type.gif)
...
![event-category](../assests/create-events/eventdetails/event-category.gif)
...
![event-subcategory](../assests/create-events/eventdetails/event-subcategory.gif)
...
- **Link to hosted event page**:  
  ...
  ![ext-url-options](../assests/create-events/eventdetails/ext-url-options.png)
...
![event-setup](../assests/create-events/eventdetails/event-setup.png)
...
![privacy](../assests/create-events/eventdetails/privacy.png)
...
![event-capacity](../assests/create-events/eventdetails/event-capacity.gif)


> **Tip:** Enable **Unlimited attendee capacity** if there’s no limit on the number of attendees.

![unlim-capacity](../assests/create-events/eventdetails/unlim-capacity.png)
...
![event-page-cust-handle](../assests/create-events/eventdetails/event-page-cust-handle.png)
...
![calender-design](../assests/create-events/eventdetails/calender-design.png)
...
![event-page-design](../assests/create-events/eventdetails/event-page-design.png)
...
![timezone](../assests/create-events/eventdetails/timezone.gif)
...
![title](../assests/create-events/eventdetails/title.png)
...
![primary-img](../assests/create-events/eventdetails/primary-images.gif)
...
![secondary-img-title](../assests/create-events/eventdetails/secondary-image-title.gif)
...
![description](../assests/create-events/eventdetails/description.png)
...
![description-img](../assests/create-events/eventdetails/description-img.gif)
