...
width="100%" 
height="400" 
src="https://www.youtube.com/embed/Rxd7gFCTVpg?si=j4-coC1GeWatVHgE" 
...
|------------------------|---------------------------------------------------------|-----------|
| **Create Events**          | Learn how to create a new event using all event builder steps | [See More](../event-management/create-event-overview)  |
| **Event Details**          | Add event title, description, categories, and visibility | [See More](../event-management/eventdetails)  |
| **Dates & Times**          | Set schedule, recurring dates, and timezones            | [See More](../event-management/datetime)  |
| **Venue & Location**       | Add venue details, maps, and location visibility        | [See More](../event-management/venuelocation)  |
| **Ticket Setup**           | Create ticket types, pricing, availability, and rules   | [See More](../event-management/ticket-setup)  |
| **Email Communication**    | Configure confirmation and reminder emails              | [See More](../event-management/email-communication)  |
| **Waitlist**               | Enable and manage event waitlist logic                  | [See More](../event-management/waitlist)  |
| **Additional Information** | Collect custom attendee information fields              | [See More](../event-management/additional-information)  |
| **Checkout Complete**      | Customize the confirmation page message                 | [See More](../event-management/checkout-complete-message)  |
| **Tags & Custom Fields**   | Use tags and custom fields for filtering and automation | [See More](../event-management/tags-and-custom-fields) |
| **Hosts**                  | Add event hosts and display them on your event page     | [See More](../event-management/hosts)  |
| **Display Settings**       | Control how events appear publicly                      | [See More](../event-management/display-settings)  |
| **Manage Events**          | View and edit all your events in one dashboard          | [See More](../event-management/manage-events)  |
...
| **Widget Customization**      | Customize ticket widget styles             | [See More](../branding-and-design/widget-customization-overview)  |
...
| **Attendee Communication**    | Customize email templates sent to attendees | [See More](../branding-and-design/attendee-communication-design)  |
...
| Functions           | Description                    | Reference |
|---------------------|--------------------------------|-----------|
| **Google Integration**  | Sync Google events and data    | [See More](../integrations/google)  |
...
| Functions          | Description                          | Reference |
|--------------------|--------------------------------------|-----------|
| **Twitch Integration** | Embed Twitch livestreams into event pages | [See More](../integrations/twitch) |
...
| Functions         | Description                              | Reference |
|-------------------|------------------------------------------|-----------|
| **Connect Shopify**   | Connect Shopify store to sell tickets    | [See More](../plugins/connect-shopify)  |
| **Connect Ecwid**     | Integrate Ecwid with Ticket Spot         | See More  |
| **Connect Wix**       | Integrate Ticket Spot into Wix website   | [See More](../plugins/connect-wix)  |
| **Connect Lovable**       | Integrate Lovable with Ticket Spot  | [See More](../plugins/connect-lovable)  |
