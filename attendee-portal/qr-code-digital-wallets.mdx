...
![my-ticket-tab](../assests/attendee-portal/qr-code-digital-wallets/my-ticket-tab.png)
...
![upcom-event](../assests/attendee-portal/qr-code-digital-wallets/upcom-event.png)

**Step 3**: Click on the **View QR Code** to see the event’s QR code.

![btn-view-qr-code](../assests/attendee-portal/qr-code-digital-wallets/btn-view-qr-code.png)
...
![view-qr-code-mod-win](../assests/attendee-portal/qr-code-digital-wallets/view-qr-code-mod-win.png)
...
![add-to-google-btn](../assests/attendee-portal/qr-code-digital-wallets/add-to-google-btn.png)

2. Review the details of your event and click on **Add** to confirm. This saves your ticket pass to your Google Wallet.

![add-btn-google](../assests/attendee-portal/qr-code-digital-wallets/add-btn-google.png)
...
![ticket-google-wallet](../assests/attendee-portal/qr-code-digital-wallets/ticket-google-wallet.png)

### For iOS (Apple Wallet)
1. Click on the **Add to Apple Wallet** below your QR code.

![add-to-apple-wallet](../assests/attendee-portal/qr-code-digital-wallets/add-to-apple-wallet.png)
...
![ios-to-wallet](../assests/attendee-portal/qr-code-digital-wallets/ios-add-to-wallet.png)
