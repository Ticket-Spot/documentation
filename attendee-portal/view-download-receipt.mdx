...
![myticket-tab](../assets/attendee-portal/view-download-receipt-pdf/myticket-tab.png)
...
![upcoming-event](../assets/attendee-portal/view-download-receipt-pdf/upcoming-event.png)

You will see the **Event Details** panel appear on the right side of the screen.

![panel-event-details](../assets/attendee-portal/view-download-receipt-pdf/panel-event-details.png)
...
![click-view-receipt](../assets/attendee-portal/view-download-receipt-pdf/click-view-receipt.gif)
...
![click-downld-pdf](../assets/attendee-portal/view-download-receipt-pdf/click-downld-pdf.gif)