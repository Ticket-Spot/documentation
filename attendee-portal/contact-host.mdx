...
![myticket-tab](../assets/attendee-portal/contact-host/myticket-tab.png)
...
![upcoming-event](../assets/attendee-portal/contact-host/upcoming-event.png)


**Step 3**: Click on the **Contact Host** in the Event Details panel, right side of the screen, to open the message window.

![click-contact-host](../assets/attendee-portal/contact-host/click-contact-host.png)
...
![cont-host-modal-win](../assets/attendee-portal/contact-host/cont-host-modal-win.gif)

A confirmation message will appear, confirming your message has been successfully sent to the host.

![success](../assets/attendee-portal/contact-host/success.png)