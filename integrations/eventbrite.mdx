...
![integration-tab](../assests/integrations/eventbrite/integration-tab.png)
...
![click-connect](../assests/integrations/eventbrite/click-connect1.png)

**Step 3:** Click on the **Connect** button again to proceed.

![click-connect2](../assests/integrations/eventbrite/click-connect2.png)


**Step 4:** Authenticate the connection to your **Eventbrite** account by entering your sign-in credentials.

![sign-in](../assests/integrations/eventbrite/sign-in.png)
...
![allow-button](../assests/integrations/eventbrite/allow-button.png)
...
![green-status](../assests/integrations/eventbrite/green-status.png)
...
![view-details](../assests/integrations/eventbrite/view-details.png)
...
![disconnect](../assests/integrations/eventbrite/disconnect.png)
