...
![integration-tab](../assests/integrations/tickettailor/integration-tab.png)
...
![click-connect1](../assests/integrations/tickettailor/click-connect1.png)


**Step 3**: Paste the **API key** you generated from your tickettailor account and click **Connect** to complete the integration.

![click-connect2](../assests/integrations/tickettailor/click-connect2.png)
...
![green-status](../assests/integrations/tickettailor/green-status.png)


## View Details

Review the connection details for your Ticket Tailor integration, including the linked account and current status. To view details, click the **horizontal ellipsis (⋯)** icon on the **Ticket Tailor integration** tile and select **View Details** from the dropdown menu.

![view-details](../assests/integrations/tickettailor/view-details.png)
...
Click the **horizontal ellipsis (⋯)** icon on the tickettailor integration tile and select **Disconnect** from the dropdown menu.

![disconnect](../assests/integrations/tickettailor/disconnect.png)
