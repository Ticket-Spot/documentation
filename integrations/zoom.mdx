...
![integration-tab](../assests/integrations/zoom/integration-tab.png)
...
![click-connect](../assests/integrations/zoom/click-connect1.png)

**Step 3:** Click on the **Connect** button again to proceed.

![click-connect2](../assests/integrations/zoom/click-connect2.png)

**Step 4:** Authenticate the connection to your **Zoom** account by entering your sign-in credentials.

![sign-in](../assests/integrations/zoom/sign-in.png)
...
![allow-button](../assests/integrations/zoom/allow-button.png)
...
![switch-account](../assests/integrations/zoom/switch-account.png)
...
![green-status](../assests/integrations/zoom/green-status.png)
...
![list-zoom-events](../assests/integrations/zoom/list-zoom-events.png)
...
![view-details](../assests/integrations/zoom/view-details.png)
...
![disconnect](../assests/integrations/zoom/disconnect.png)
