...
![member-roles](../assets/team/invite-team-roles/member-roles.png) 
...
![click-add-btn](../assets/team/invite-team-roles/click-add-btn.png)

Once the team member is invited, they appear in the list with their **role**, **account status**, and **invite date**.

![display-member](../assets/team/invite-team-roles/display-member.png)
