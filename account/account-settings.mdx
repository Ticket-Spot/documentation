...
![click-account-settings](../assets/account/account-settings/click-acc-settings.png)
...
![three-tabs](../assets/account/account-settings/three-tabs.png)
...
![profile-fields](../assets/account/account-settings/profile-fields.png)

After updating your information, click **Save Changes** to apply your updates.

![profile-save-changes](../assets/account/account-settings/profile-save-changes.png)
...
![warning-email](../assets/account/account-settings/warning-email.png)
...
![change-pass](../assets/account/account-settings/change-pass.png)

2. Click on **Change Password** to save your new credentials.

![click-change-pass](../assets/account/account-settings/click-change-pass.png)
...
![submit-otp](../assets/account/account-settings/submit-otp.png)  
...
![referral-link](../assets/account/account-settings/referral-link.png)
