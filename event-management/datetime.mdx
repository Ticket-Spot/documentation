...
![one-time-event](../assets/create-events/datetime/one-time-event.gif)
...
![onetime-all-day-event](../assets/create-events/datetime/onetime-all-day-event.png)
...
![recurring-daily](../assets/create-events/datetime/recurring-daily.gif)

- **Weekly:**  
The event will repeat every week on your chosen days (e.g., Monday, Wednesday, Friday).

![recurring-weekly](../assets/create-events/datetime/recurring-weekly.gif)
...
![weekly-note](../assets/create-events/datetime/weekly-note.png)
...
![recurring-monthly](../assets/create-events/datetime/recurring-monthly.gif)
...
![monthly-end-date](../assets/create-events/datetime/monthly-end-date.gif)
...
![recurring-yearly](../assets/create-events/datetime/recurring-yearly.gif)
...
![yearly-end-date](../assets/create-events/datetime/yearly-end-date.gif)
...
![no-date-in-mind](../assets/create-events/datetime/no-date-in-mind.png)
...
![specific-dates](../assets/create-events/datetime/specific-dates.gif)


> **Tip:** Check the **All Day Event** box if your event runs for the entire day or doesn’t have a specific start and end time. This helps display your event properly on the schedule without fixed hours.
![spec-date-all-day-event](../assets/create-events/datetime/spec-date-all-day-event.png)
...
![time-based](../assets/create-events/datetime/time-based.gif)
