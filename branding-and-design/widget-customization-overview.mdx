...
To install the widget, click the **Installation** button, choose your platform (**Any Website**, **Shopify**, **WordPress**, or **Wix**), and **copy** the code shown on the screen. Paste it into your website or follow the steps provided in each tab to complete the setup.

![click-installation](../assets/branding-and-design/widget-customization-overview/click-installation.gif)
